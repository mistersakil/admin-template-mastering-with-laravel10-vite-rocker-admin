<div class="sidebar-wrapper" data-simplebar="true">
    <div class="sidebar-header">
        <div>
            <img src="{{ Vite::image('logo-icon.png') }}" class="logo-icon" alt="logo icon">
        </div>
        <div>
    ...
    <div class="pro-card border border-light-2 bg-light-transparent p-3 radius-10 mx-3">
        <p class="text-light">Rocker Premium Template has full features of all UI Components for admin panel.
        </p>
        <div class="d-grid">
            <a href="https://codervent.gumroad.com/l/rocker" target="_blank" class="btn btn-primary radius-10">Upgrade
                to Pro!</a>
        </div>
    </div>
</div>